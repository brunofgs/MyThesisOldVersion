...
% Thesis title
\title{Geração Automática de Testes de Unitários}

% Author and highest current degree (not the one you are applying to)
\author{Bruno Sousa}
\degree{Mestrado Bolonha em Engenharia Informática e de Computadores - Alameda}
...
\begin{figure}[t]
\centering
\subfigure[caption for subfigure a]{\includegraphics[scale=0.65]{img1.eps}\label{chp3:img1}}
\hspace*{0.5cm}
\subfigure[caption for subfigure b]{\includegraphics[scale=0.65]{img2.eps}\label{chp3:img2}}\\
